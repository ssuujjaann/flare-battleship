...
**Even though the location(coordinates) of the warships on the board is usually hidden from the players, for this exercise and ease of testing all the use cases, the location of the warships is displayed at the start once they've been deployed.** 
